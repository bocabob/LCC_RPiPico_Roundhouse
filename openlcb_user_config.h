...
//   63 = LEN_SNIP_USER_NAME_BUFFER (63)    // definded in openlcb_types.h but needs to be = 62 for correct display in JMRI and other tools that expect a null terminator at the end of the name string
